...
function userInfo(session: ReturnType<typeof useSession>["data"]) {
...
export default function ChatPage() {
  ...
  const currentTitle = activeSession?.title ?? "แชทใหม่"
    ...
    >
      ...
      <div className="main">
        <Topbar
          ...
          sub={
            activeSession
              ? `เริ่ม ${new Date(activeSession.createdAt).toLocaleDateString("th-TH", { day: "numeric", month: "short" })}`
              : undefined
          }
          onShare={() => showToast("ลิงก์แชร์ถูกคัดลอกแล้ว")}
        ...
        <Composer
          ...
          onSend={() => handleSend()}
          disabled={isThinking}
          hint={activeSession ? "พิมพ์ต่อบทสนทนา..." : undefined}
        />
      </div>
